...
%% Packet Size
% Symbols
Ns = 3e4 ;% Sembol sayısı
% Symbols per packet
Nm = 1e1 ;% Bir paketteki sembol miktarı
N = Ns/Nm ; %Paket sayısı
...
xlabel(' EbNo [dB] ')
ylabel(' BER ')
legend('BER NCOH AWGN Theory','BER NCOH Ray Theory','BER COH AWGN Theory','BER NCOH AWGN Simulation','BER NCOH Ray Simulation','BER COH AWGN Simulation','BER COH Ray Simulation');
box on
grid on
% SER
figure()
...
xlabel(' EsNo [dB] ')
ylabel(' SER ')
legend('SER NCOH AWGN Theory','SER NCOH Ray Theory','SER COH AWGN Theory','SER NCOH AWGN Simulation','SER NCOH Ray Simulation','SER COH AWGN Simulation','SER COH Ray Simulation');
box on
grid on
% PER
figure()
...
xlabel(' SNR [dB] ')
ylabel(' PER ')
legend('PER NCOH AWGN Theory','PER NCOH Ray Theory','PER COH AWGN Theory','PER NCOH AWGN Simulation','PER NCOH Ray Simulation','PER COH AWGN Simulation','PER COH Ray Simulation');
box on
grid on